...
$$
\mathbb E[y|x]=\mathbb E[\beta_0+\beta_1x+u]=\beta_0+\beta_1x
$$
...
![[new/uga/l3/s5/eco/S5 éco économétrie 1/01 rappels et régression linéaire/Untitled.png]]
...
$$
\text{Cov}(x, u)=\mathbb E[u|x]=0
$$

Ce qui implique donc :

$$
\mathbb E[\underbrace{y-\beta_1x-\beta_0}_u]=0 \text{ et } \text{Cov}(x,u)=\mathbb E[x,(y-\beta_1x-\beta_0)]=0
$$
...
{\sum_{i=1}^n(x_i-\bar x)^2}=\frac{\text{Cov}(x,y)}{\text{Var}(x)}
...
![[new/uga/l3/s5/eco/S5 éco économétrie 1/01 rappels et régression linéaire/Untitled 1.png]]
