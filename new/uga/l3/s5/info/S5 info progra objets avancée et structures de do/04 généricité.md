...
![Joker avec `extends` : le type paramètre est un `Point` ou plus spécifique.](new/uga/l3/s5/info/S5%20info%20progra%20objets%20avancée%20et%20structures%20de%20do/04%20généricité/Untitled.png)

Joker avec `extends` : le type paramètre est un `Point` ou plus spécifique.

![Joker avec `super` : le type paramètre est un `Point3D` ou plus générale.](new/uga/l3/s5/info/S5%20info%20progra%20objets%20avancée%20et%20structures%20de%20do/04%20généricité/Untitled%201.png)
