...
![Régions de type I.](new/uga/l2/s3/math/S3%20math%20analyse%20réelle%203/04%20fonctions%20à%20deux%20variables/Untitled.png)

Régions de type I.

![Régions de type II.](new/uga/l2/s3/math/S3%20math%20analyse%20réelle%203/04%20fonctions%20à%20deux%20variables/Untitled%201.png)
...
$$
\text{ Type I : }
∬_Df(x,y)dy dx=∫^b_a\left[∫^{g_2(x)}_{g_1(x)}f(x,y)dy\right]dx
...
\text{ Type II : }
∬_Df(x,y)dy dx=∫^d_c\left[∫^{h_2(y)}_{h_1(y)}f(x,y)dx\right]dy
$$
