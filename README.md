Coffre Obsidian pour tous mes cours d'éducation supérieur, y compris :

- Licence MIASHS, UGA
- Cursus Ingénieur par apprentissage, ENSIMAG
...
- ENSIMAG : STYLE CHEAT SHEETS
  - Algo
  - Intro à unix
  - Probas appliquées -> Pointe vers cours de probas et stats, puis écris le processus de Poisson et écris aussi sur les Modèles de Mixture Gaussiennes (et telecharge biblio des stochastiques)
  - Recherche op, comment tracer des graphes en Obsidian ?
  - Analyse -> Pointe vers Analyse réelle et Algèbre linéaire
  - Automates
  - Grammaires
  - Archi
  - Logiciel de base
