...
![Exemple avec la notation $x/a$. Cette machine ne fais que lire (aucune écriture) des ‘a’ et ‘b’ en se déplaçant à droite après chaque lecture, jusqu’à ce qu’elle rencontre un vide $\#$, où elle rentre dans l’état final et elle s’arrete.](ressources/06_machines_de_turing_untitled.png)
...
![Exemple avec la notation $x/y/d$.](ressources/06_machines_de_turing_untitled_1.png)
