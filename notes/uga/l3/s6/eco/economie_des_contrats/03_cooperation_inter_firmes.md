...
- Dans quelle mesure les ententes sont-elles nuisibles à la collectivité ?
- Quelles sont les politiques mises en œuvre contre les ententes (cas des États-Unis et de l'Europe) ?
...
- **Collusion (générale)** : lorsque les firmes s'entendent ou se coordonnent pour accroître leur pouvoir de marché ensemble.
    - **Pouvoir de marché** : la capacité de proposer un prix supérieur au coût marginal
- **Collusion (droit)** : Selon l'art. L. 420-1 du code de commerce, accord ou action concertée qui a pour objet ou peut avoir pour effet d'empêcher, de restreindre ou de fausser le jeu de la concurrence sur un marché de produits ou de services déterminés.

Une collusion a deux caractéristiques : elle augmente les profits pour les parties, et elle se fait au détriment du consommateur.

Il existe **deux formes de collusion** :

- **Tacite** : les firmes se coordonnent de façon non coopérative sans accord formel
- **Explicite** : les firmes passent un contrat formel pour se coordonner sur le prix, les quantités, les investissements, les parts de marché, etc.
...
- **Profits totaux en oligopole < profits totaux en monopole**
- **Externalités à la compétition** : "fais partie de mon entente ou tu auras des inconvénients économiques"
- Les firmes vont naturellement chercher un accord pour accroître leur pouvoir de marché

**Formes de collusion possibles** :
- Fixation des prix
- Répartition des marchés/clients
...
- **Petit nombre de firmes**
    ...
    - Diminue le coût de contrôle et de respect des engagements
- **Détenant une part importante du marché**
    - Relation entre part de marché et pouvoir de marché, permet de contrôler plus facilement le prix
- **Firmes de taille homogène**
    - Structure de coûts et capacités financières proches, plus facilement de s'entendre sur les prix et les quantités
- **Biens homogènes** : collusion plus fréquente, plus facile de s'entendre
- **Biens intermédiaires** : faible part du coût total du produit fini, absence de substitut proche
- **Coûts fixes importants**
    - Il faut utiliser la pleine capacité des moyens de production, ce qui exige d'avoir un prix plutôt élevé
- **Taux d'actualisation semblable**
    - Anticipations sur l'avenir proche et espérances des retours sur investissements proches, en termes de gains futurs
...
- **Faible concentration des acheteurs et transactions fréquentes**
    ...
    - Incitations à tricher qui sont réduites grâce aux transactions fréquentes

**Conditions sur l'état du marché** :

- **Marché transparent et stable** :
    - Les prix pratiqués sont faciles à observer (ex : marchés publics)
    - Les firmes peuvent facilement communiquer sur les décisions stratégiques
    - Marché stable : les concurrents sont les mêmes depuis longtemps, peu d'entrées et de sorties
    - Le cycle de vie du produit est assez long
    - Des produits matures ou en fin de vie où la tentation de collusion est un réflexe de survie
    - Des marchés où le rythme d'innovation est assez lent
- **Absence de franc-tireur** ou free-rider
...
**Situation de base** :
- Deux entreprises 1 et 2, ayant le même coût marginal constant $c = 30$
...
**Solution de cartel (monopole intégré)** :
- Production totale optimale : $Q = 60$
- Répartition : $q_1 = q_2 = 30$
- Prix : $P = 90$
...
2. Projets avec échéance connue
3. Marchés avec fin de vie programmée

**Théorème de Selten** : *Si le jeu de base a un équilibre de Nash unique, alors pour un nombre fini de répétitions (T), le jeu répété a un équilibre de Nash parfait en sous-jeu unique, qui est l'équilibre de Nash du jeu de base joué à chaque étape.*

**Démonstration par induction à rebours** :
- À la dernière période, pas d'incitation à coopérer
- À l'avant-dernière période, sachant que la coopération ne marchera pas à la dernière période, pas d'incitation à coopérer
- Et ainsi de suite jusqu'à la première période

**Conclusion** : dans un jeu à horizon fini, la collusion ne peut pas être maintenue de façon rationnelle.
...
**Cette motivation à continuer le jeu sera-t-elle plus forte que les gains de court terme de la déviation ?** Ceci va dépendre :
...
- **Si déviation** : passer à l'équilibre de Nash non coopératif dès qu'une firme dévie, et cela pour toutes les périodes suivantes

**Notations** :
- $\pi^D$ : profit de déviation sur une période
- $\frac{1}{2}\pi^M$ : profit de cartel sur une période (moitié du profit de monopole)
- $\pi^N$ : profit à l'équilibre de Nash non coopératif
...
**En d'autres termes** : toute issue de jeu Pareto améliorante par rapport à un équilibre de Nash du jeu non répété est un équilibre possible du même jeu infiniment répété, à condition que la valeur du futur pour les joueurs soit suffisante.
...
**Exemple avec $n$ firmes en Bertrand** :
- Chaque firme a un profit $\frac{\pi^M}{n}$ si elle participe au cartel
- Elle obtient $\pi^M$ si elle dévie
- Condition : $\delta(n) > 1 - \frac{1}{n} \equiv \delta^*$
...
- L'entrant fixe le prix concurrentiel $p = c$
- L'entrée ne dure qu'une période ("hit and run")

**Résultat** : $\delta > \frac{1}{2-\mu} \equiv \delta^*$

Le facteur d'escompte critique $\delta^*$ augmente avec la probabilité $\mu$ d'entrée.
...
**L'intérêt de passer par la CSO** :
- Contrôle de l'offre mondiale
- Stabilisation des prix
- Marketing coordonné ("A diamond is forever")
...
- Diverses hypothèses sur le comportement des membres

**Pourquoi la défection généralisée ne s'impose-t-elle pas ?**
Comment l'Arabie Saoudite arrive-t-elle à dissuader la défection ?

**La punition traditionnelle requiert deux conditions** :
1. Capacité de détecter la tricherie
2. Capacité de punir efficacement

**Pour l'OPEP** :
- Condition 1 est satisfaite (volumes observables)
- Condition 2 plus difficilement satisfaite car les coûts de punition sont élevés

**Stratégies de l'Arabie Saoudite** :
- 1983-1985 : stratégie conciliante (absorption des déviations)
- À partir de 1985 : sanction de type "Tit-for-Tat" (guerre des prix)
...
- Transfert du surplus des consommateurs vers les producteurs
...
- Article 82 (ex 86) : interdiction des abus de position dominante
...
**Comment les collusions sont-elles repérées ?**

1. **Autosaisine des juridictions**
2. **Accords de clémence (leniency programs)** :
...
**Amendes (21 novembre 2001)** : 855,22 millions €
- BASF : 296,16 millions €
- Hoffman La Roche : 462 millions €
- Aventis : 5,04 millions €

**Pratiques** :
- Ententes tacites sur partage des marchés et fixation des prix
- Premier accord en septembre 1989 à Zurich
- Entente stable 1989-2001
...
- Esso, Shell, BP : 5 millions € chacune
...
**Pratiques (mai 2011-juillet 2012)** : manipulation des taux de change

**Rôle de la clémence** : certaines banques ont bénéficié de réductions pour avoir coopéré avec l'enquête
...
- Le partenariat industriel permet-il de résoudre des problèmes d'asymétrie d'informations ?
- Comment partager le risque entre le client et son fournisseur dans un contrat de partenariat ?
...
- Observation des processus de décision dans les organisations
- Le comportement devient un objet d'analyse

**Point de départ** : mise en cause de la rationalité parfaite. Cette théorie ne peut pas rendre compte des procédures effectives de décision.

**La rationalité limitée (ou procédurale) repose sur trois principes** :

1. **La décomposition des problèmes complexes**
   - Parabole des horlogers Tempus et Hora

2. **La recherche de résultats satisfaisants et non optimaux (satisficing)**
   - Parabole de l'aiguille dans la meule de foin
   - Choix en termes de niveaux d'aspiration (aspiration levels)
   - Règles empiriques fondées sur l'expérience (rules of thumb) : mark-up pricing, management de projets
...
- **L'opportunisme pré-contractuel** : la sélection adverse
- **L'opportunisme post-contractuel** : l'aléa moral
...
- **En retour** : engagement de performance et d'amélioration continue

**Reconduction du contrat et incitation à coopérer** :
- Passage d'un jeu à un coup à un jeu répété (forte probabilité de reconduction)
...
- $w$ : variable aléatoire représentant les fluctuations imprévisibles du coût, observées seulement par le fournisseur
- $\beta$ : paramètre de partage de l'effort du fournisseur pour diminuer ses coûts
- $e$ : réduction de coût réalisée grâce aux gains de productivité du fournisseur

**Cas particuliers** :
- $\alpha = 0, \beta = 1$ : contrat à prix fixe pur
...
2. Les efforts de diminution du coût du fournisseur
...
**1987** : Document d'évaluation d'aptitude qualité édicté par les constructeurs
- Définition de 5 étapes d'évaluation

**1988** : Création de l'AFAQ (Association Française pour l'Assurance de la Qualité)

**Jusqu'en 1989** : Équipementiers classés selon 4 rangs A, B, C, D
- Nécessité d'être A ou B pour être retenu

**Depuis 1993** : Obligation d'être classé A
...
**Norme ISO** : Document qui fournit des exigences, des spécifications, des lignes directrices ou des caractéristiques à utiliser systématiquement pour assurer que les matériaux, produits, processus et services sont aptes à leur emploi.
...
4. **Conditions de soutenabilité** : $\delta > \delta^*$ où $\delta^*$ dépend des profits relatifs de coopération, déviation et punition

5. **Facteurs favorables à la collusion** :
...
2. **L'incomplétude génère des asymétries d'information** qui rendent possibles des comportements opportunistes

3. **Le partenariat comme solution** :
   - **À l'aléa moral** : contrats de moyen terme, partage risques/incitations, stimulation à l'innovation
   - **À la sélection adverse** : classification des fournisseurs, normes de qualité

4. **Trade-off fondamental** : plus d'incitations vs meilleur partage des risques

5. **Instruments pratiques** :
   - Reconduction contractuelle
   - Formules de partage $\alpha$ et $\beta$
...
- **Collusion** : coordination horizontale pour exercer un pouvoir de marché (généralement interdite)
- **Partenariat** : coordination verticale pour améliorer l'efficacité de la chaîne de valeur (généralement autorisée)

Dans les deux cas, la **répétition des interactions** et la **réputation** jouent un rôle crucial pour maintenir la coopération.