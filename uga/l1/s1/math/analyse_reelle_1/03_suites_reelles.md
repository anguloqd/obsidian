...
>[!example] Exemple
>La suite des nombres pairs peut être définie par son terme général :
>
...
>- De $u_n \neq u_0$, en retranchant $u_2 = au_1 + b$ à $u_1 = au_0 + b$, on obtient $a = \frac{u_2-u_1}{u_1-u_0}$, et alors $b = u_1 - au_0$.

>[!example]- Calcul du terme général
>Si $a \neq 1$, le calcul du terme général d'une suite arithmético-géométrique vérifiant $u_{n+1} = au_n + b$ se ramène à celui d'une suite géométrique.
>
